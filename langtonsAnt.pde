...
int gridColor   = #202020;     // the grid line color
...
void setup() {
  ...
  if (fillVoid) intoTheVoid(); // fills the initial frame up if option is selected
}
...
void draw() {
  ...
  if (autoSave) saveFrame(fileName);
}
